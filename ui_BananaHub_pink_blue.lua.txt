...
-- ============================================================
-- THEME: HỒNG NHẠT + XANH DA TRỜI NHẠT
-- Nền tối tím hồng + accent xanh da trời pastel + viền hồng nhạt
-- ============================================================
local T1UIColor = {
    ["Border Color"]                  = Color3.fromRGB(255, 182, 193), -- hồng nhạt
    ["Click Effect Color"]            = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Setting Icon Color"]            = Color3.fromRGB(250, 218, 221), -- hồng trắng nhạt
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Search Icon Highlight Color"]   = Color3.fromRGB(180, 225, 245), -- xanh nhạt hơn
    ["GUI Text Color"]                = Color3.fromRGB(255, 255, 255), -- trắng
    ["Text Color"]                    = Color3.fromRGB(255, 255, 255), -- trắng
    ["Placeholder Text Color"]        = Color3.fromRGB(180, 140, 155), -- hồng xám
    ["Title Text Color"]              = Color3.fromRGB(255, 255, 255), -- trắng

    ["Background Main Color"]         = Color3.fromRGB(45,  31,  46),  -- tím hồng tối
    ["Background 1 Color"]            = Color3.fromRGB(55,  37,  58),  -- hồng tím lớp 1
    ["Background 1 Transparency"]     = 0.05,
    ["Background 2 Color"]            = Color3.fromRGB(61,  40,  65),  -- hồng tím lớp 2
    ["Background 3 Color"]            = Color3.fromRGB(52,  34,  56),  -- hồng tím lớp 3
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Section Text Color"]            = Color3.fromRGB(255, 255, 255), -- trắng
    ["Section Underline Color"]       = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Toggle Border Color"]           = Color3.fromRGB(100,  65, 105), -- hồng tím vừa
    ["Toggle Checked Color"]          = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Toggle Desc Color"]             = Color3.fromRGB(250, 218, 221), -- hồng trắng nhạt

    ["Button Color"]                  = Color3.fromRGB(61,  40,  65),  -- hồng tím nhạt
    ["Label Color"]                   = Color3.fromRGB(52,  34,  56),  -- hồng tím tối
    ["Dropdown Icon Color"]           = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Dropdown Selected Color"]       = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 255, 255), -- trắng

    ["Textbox Highlight Color"]       = Color3.fromRGB(137, 207, 240), -- xanh da trời
    ["Box Highlight Color"]           = Color3.fromRGB(255, 182, 193), -- hồng nhạt
    ["Slider Line Color"]             = Color3.fromRGB(70,  45,  75),  -- hồng tím tối
    ["Slider Highlight Color"]        = Color3.fromRGB(137, 207, 240), -- xanh da trời
...
mainButton.BackgroundColor3 = Color3.fromRGB(55, 37, 58)
...
UIStroke.Color = Color3.fromRGB(137, 207, 240)
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, {
					BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				}):Play()
			else
				TweenService:Create(mainButton, tweenOff, {
					BackgroundColor3 = Color3.fromRGB(45, 31, 46)
				}):Play()
			end
...
mainButton.MouseEnter:Connect(function()
    ...
    TweenService:Create(mainButton, hoverTweenInfo, {
        BackgroundColor3 = Color3.fromRGB(52, 34, 56)
    }):Play()
end)

mainButton.MouseLeave:Connect(function()
    isHovering = false
    local targetColor = isToggled and Color3.fromRGB(45, 31, 46) or Color3.fromRGB(61, 40, 65)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	Topnoti.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	Ruafimg.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	TextLabelNoti.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	CloseContainer.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	CloseImage.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	TextButton.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	if Description then
		...
		TextLabelNoti2.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
...
function Library:CreateWindow(Setting)
	...
	Main.BackgroundColor3 = Color3.fromRGB(55, 37, 58)
	...
	maingui.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(45, 31, 46)
	MainContainer.Size = UDim2.new(1, 0, 1, 0)

	local uistr = Instance.new("UIStroke", MainContainer);
	uistr.Thickness = 1;
	uistr.Color = Color3.fromRGB(255, 182, 193);
	...
	Concacontainer.BackgroundColor3 = Color3.fromRGB(55, 37, 58)
	...
	Concacmain.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	TopMain.BackgroundColor3 = Color3.fromRGB(52, 34, 56)
	...
	TopStroke.BackgroundColor3 = Color3.fromRGB(137, 207, 240)
	...
	TextLabelMain.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
   ...
   TextLabelMain.Text = "<font color=\"rgb(0,0,0)\">" .. tostring(TitleNameMain or "Night Mystic") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	ControlList.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	ControlTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
	...
	local PageCounter = 1
		...
		PageNameControl.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		Line.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		TabTitleContainer.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		TabTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		PageButton.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		PageTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		PageList.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
			Topsec.BackgroundTransparency = 1.000
			Topsec.Size = UDim2.new(0, 415, 0, 30)

			Sectiontitle.Name = "Sectiontitle"
			Sectiontitle.Parent = Topsec
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
			...
			if Toggleable then
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(55, 37, 58)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				check.BackgroundColor3 = Color3.fromRGB(137, 207, 240) -- xanh da trời (base)
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(250, 218, 221)
				...
				UIGradient_1.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
					ColorSequenceKeypoint.new(0.4, Color3.fromRGB(180, 225, 245)),
					ColorSequenceKeypoint.new(0.6, Color3.fromRGB(255, 182, 193)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(137, 207, 240))
				}
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(70, 45, 75)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(61, 40, 65)
